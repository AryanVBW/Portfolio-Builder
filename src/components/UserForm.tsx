    ...
    >
      <div className="space-y-6">
        ...
        <motion.div
          ...
          className="space-y-2"
        >
          <h3 className="text-lg font-medium bg-gradient-to-r from-primary-600 to-secondary-600 text-transparent bg-clip-text">
            Profile Image
          </h3>
          <ImageUpload
            currentImage={userData.profileImage}
            onImageSelect={(imageBase64) => setUserData({ ...userData, profileImage: imageBase64 })}
          />
        </motion.div>
